...
function render() {
    ...
    */
    for (let i = 0; i < 5; i++) {
        let nuevoCirculo = new Circulo({ borderColor: "black" }); // Definimos un parametro para el color del borde para que estos nuevos círculos sean diferentes del que creamos fuera del ciclo for.
